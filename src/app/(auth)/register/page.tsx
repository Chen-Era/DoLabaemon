      ...
      <div className="page-container">
        <div className="grid gap-6 lg:grid-cols-[1fr_minmax(380px,1fr)]">
          <section className="app-panel-strong px-6 py-8 md:px-8">
            ...
            <h1 className="mt-4 text-4xl font-semibold tracking-tight text-white">创建你的 Dorlabaemon 工作区</h1>
            ...
            <div className="data-grid mt-8">
              <div className="app-panel px-5 py-4">
                <p className="font-medium text-white">统一命名与标签</p>
                <p className="section-copy mt-2 text-sm">把零散试剂记录转为可筛选、可判断的标准化条目。</p>
              </div>
              <div className="app-panel px-5 py-4">
                <p className="font-medium text-white">实验准备显式化</p>
                <p className="section-copy mt-2 text-sm">在真正开做实验前，先看最低必需项和风险提示是否满足。</p>
              </div>
              <div className="app-panel px-5 py-4">
                <p className="font-medium text-white">协作边界清晰</p>
          ...
          <section className="app-panel px-6 py-8 md:px-8">
            <div className="mb-6">
              ...
              <h2 className="mt-3 text-2xl font-semibold text-white">注册并初始化实验室</h2>
            ...
            <p className="mt-5 text-sm text-zinc-400">
              已有账号？
              <Link href="/login" className="ml-2 text-cyan-200 underline underline-offset-4">
                登录
              </Link>
            </p>
          </section>
