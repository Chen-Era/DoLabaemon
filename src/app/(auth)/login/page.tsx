      ...
      <div className="page-container">
        <div className="grid gap-6 lg:grid-cols-[1.05fr_minmax(360px,0.95fr)]">
          <section className="app-panel-strong px-6 py-8 md:px-8">
            ...
            <h1 className="mt-4 text-4xl font-semibold tracking-tight text-white">登录你的实验准备工作区</h1>
          ...
          <section className="app-panel px-6 py-8 md:px-8">
            <div className="mb-6">
              ...
              <h2 className="mt-3 text-2xl font-semibold text-white">继续进入 Dorlabaemon</h2>
            ...
            <p className="mt-5 text-sm text-zinc-400">
              还没有账号？
              <Link href="/register" className="ml-2 text-cyan-200 underline underline-offset-4">
                注册
              </Link>
            </p>
          </section>
